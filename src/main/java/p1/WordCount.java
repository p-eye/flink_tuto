...
public class WordCount {
  public static void main(String[] args) throws Exception {
    ...
    DataSet<String> text =
        env.readTextFile(params.get("input")); // [Noman Joyce Noman Sayuri Frances ...]
    ...
    DataSet<Tuple2<String, Integer>> tokenized =
        filtered.map(new Tokenizer()); // [(Noman, 1), (Nipun, 1), (Noman, 1) ...]
