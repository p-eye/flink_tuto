...
public class AverageProfit {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> data = env.readTextFile("/Users/mk-mac-281/Downloads/flink_tuto_lecture/reduce operator_flink_version_1.12/avg");
        ...
        profitPerMonth.writeAsText("/Users/mk-mac-281/Downloads/flink_tuto_output/profit_per_month.txt");
    ...
    public static class MyMap implements MapFunction<Tuple5<String, String, String, Integer, Integer>, Tuple2<String, Double>> {
        /*
